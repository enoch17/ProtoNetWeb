    ...
    <div class="left">
        ...
        <form method="post" action="editbundle.php">
            <input type="text" name="bundlename" placeholder="Bundle Name" value="<?php echo $_SESSION['bundlename']?>"
                required />
            <input type="text" name="bundlesize" placeholder="Bundle Size" value="<?php echo $_SESSION['bundlesize']?>"
                required />
            <input type="text" name="description" placeholder="Description"
                value="<?php echo $_SESSION['description']?>" required />
            <input type="text" name="duration" placeholder="Duration in Days" value="<?php echo $_SESSION['duration']?>"
                required />
            ...
            <input type="submit" name="EditBundle" value="Edit Bundle" />
        </form>
    </div>
    <!-- html ends here -->
    <?
